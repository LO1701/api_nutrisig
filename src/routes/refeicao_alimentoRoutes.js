...
routesRefeicao_alimento
    ...
    .get('/usuario/plano/:id_plano/refeicao/:id_refeicoes/alimento/refeicaoAlimento', AuthUsuario.verificaToken, refeicao_alimentoController.buscaTodasRefeicoes_alimentos)  
    ...
    .put('/usuario/plano/:id_plano/refeicao/:id_refeicoes/alimento/:id_alimentos/refeicaoAlimento', AuthUsuario.verificaToken, refeicao_alimentoController.atualizaRefeicoes_alimentos)   
